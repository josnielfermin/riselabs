export const Content = {
  ...
  products: {
    title: "OUR PRODUCTS",
    description:
      "Get to know our products and see how we’re shaping the next era of DeFi.",
    items: [
      {
        title: "Nest",
        subtitle: "The MetaDex for HyperEVM",
        description:
        ...
        images: [
          ...
          "/static/images/modal-preview/nest-03.png",
          "/static/images/modal-preview/nest-04.png",
        ],
      },
      {
        title: "Hype Engine",
        ...
        images: [
          ...
          "/static/images/modal-preview/hype-engine-03.png",
    ...
    members: [
      {
        name: "Satsy",
        role: "CEO",
        image: "/static/images/team/satsy.png",
      },
      {
        name: "Telaga",
        role: "COO",
        image: "/static/images/team/telaga.png",
      },
      {
        name: "Moab",
        role: "CTO",
        image: "/static/images/team/moab.png",
      },
      {
        name: "Ace",
        role: "CSO",
        image: "/static/images/team/ace.png",
      },
      {
        name: "Sather",
        role: "CPO",
        image: "/static/images/team/sather.png",
      },
    ],
  },
  socials: {
    ...
    links: [
      {
        name: "X",
        icon: "icon-x-1",
        url: "https://x.com/riselabs",
      },
      {
        name: "Gitbook",
        icon: "icon-gitbook",
        url: "https://www.gitbook.com/@riselabs",
      },
      {
        name: "Discord",
        icon: "icon-discord-1",
        url: "https://discord.com/invite/riselabs",
      },
      {
        name: "Medium",
        icon: "icon-medium-1",
        url: "https://medium.com/@riselabs",
      },
    ],
  },
};
